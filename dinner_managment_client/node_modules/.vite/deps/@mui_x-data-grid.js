...
} from "./chunk-5WABFEJG.js";
import {
  LinearProgress_default
} from "./chunk-33P42PDK.js";
import {
  Grow_default,
  Popper_default,
  Tooltip_default
} from "./chunk-6UZ46X2S.js";
import {
  require_react_dom
} from "./chunk-3LEBMX3J.js";
import {
  createSvgIcon
} from "./chunk-W3SQMQUC.js";
import {
  useId_default
} from "./chunk-FAJMTVZN.js";
import "./chunk-IXXZHOGC.js";
import {
  useThemeProps
} from "./chunk-2XUYQGY7.js";
import {
  styled_default as styled_default2
} from "./chunk-NBRTTMGN.js";
import {
  toPropertyKey
...
var require_reactMajor = __commonJS({
  "node_modules/@mui/x-internals/reactMajor.js"(exports) {
    ...
    var React154 = _interopRequireWildcard(require_react());
    var _default = exports.default = parseInt(React154.version, 10);
  }
});
...
var import_reactMajor = __toESM(require_reactMajor());

// node_modules/@mui/x-data-grid/hooks/utils/useGridPrivateApiContext.js
var React31 = __toESM(require_react());
var GridPrivateApiContext = React31.createContext(void 0);
if (true) {
  GridPrivateApiContext.displayName = "GridPrivateApiContext";
}
function useGridPrivateApiContext() {
  const privateApiRef = React31.useContext(GridPrivateApiContext);
...
var useGridVirtualScroller = () => {
  ...
  const mainRefCallback = React34.useCallback((node) => {
    ...
    if (import_reactMajor.default >= 19) {
      return () => {
  ...
  const scrollPosition = React34.useRef(EMPTY_SCROLL_POSITION);
  ...
  const focusedCell = {
    rowIndex: React34.useMemo(() => cellFocus ? currentPage.rows.findIndex((row) => row.id === cellFocus.id) : -1, [cellFocus, currentPage.rows]),
    columnIndex: React34.useMemo(() => cellFocus ? visibleColumns.findIndex((column) => column.field === cellFocus.field) : -1, [cellFocus, visibleColumns])
  };
...
var GridMainContainer = React39.forwardRef((props, ref) => {
  var _a;
  const rootProps = useGridRootProps();
...
var GridVirtualScrollerContent = React42.forwardRef(function GridVirtualScrollerContent2(props, ref) {
  var _a;
  const rootProps = useGridRootProps();
...
var GridVirtualScrollerRenderZone = React44.forwardRef(function GridVirtualScrollerRenderZone2(props, ref) {
  const {
    className
...
var GridVirtualScrollbar = React45.forwardRef(function GridVirtualScrollbar2(props, ref) {
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
...
var GridPanel = React75.forwardRef((props, ref) => {
  const {
    children,
    className
  ...
  const [isPlaced, setIsPlaced] = React75.useState(false);
  const handleClickAway = React75.useCallback(() => {
    apiRef.current.hidePreferences();
  }, [apiRef]);
  const handleKeyDown = React75.useCallback((event) => {
    if (event.key === "Escape") {
      apiRef.current.hidePreferences();
    }
  }, [apiRef]);
...
true ? GridPanel.propTypes = {
  ...
  ownerState: import_prop_types38.default.object
} : void 0;
...
var GridFilterForm = React79.forwardRef(function GridFilterForm2(props, ref) {
  ...
  const valueRef = React79.useRef(null);
  const filterSelectorRef = React79.useRef(null);
  ...
  const sortedFilteredColumns = React79.useMemo(() => {
    switch (columnsSort) {
      case "asc":
  ...
  const currentOperator = React79.useMemo(() => {
    var _a2;
  ...
  const changeColumn = React79.useCallback((event) => {
  ...
  const changeOperator = React79.useCallback((event) => {
  ...
  const changeLogicOperator = React79.useCallback((event) => {
  ...
  React79.useImperativeHandle(focusElementRef, () => ({
    focus: () => {
      var _a2;
...
var GridFilterPanel = React80.forwardRef(function GridFilterPanel2(props, ref) {
  var _a, _b;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const filterModel = useGridSelector(apiRef, gridFilterModelSelector);
  ...
  const lastFilterRef = React80.useRef(null);
  const placeholderFilter = React80.useRef(null);
  const {
    logicOperators = [GridLogicOperator.And, GridLogicOperator.Or],
    columnsSort,
    filterFormProps,
  ...
  const applyFilterLogicOperator = React80.useCallback((operator) => {
    apiRef.current.setFilterLogicOperator(operator);
  }, [apiRef]);
  const getDefaultFilter = React80.useCallback(() => {
  ...
  const getNewFilter = React80.useCallback(() => {
  ...
  const {
    readOnlyFilters,
    validFilters
  } = React80.useMemo(() => items.reduce((acc, item) => {
  ...
  const addNewFilter = React80.useCallback(() => {
  ...
  const deleteFilter = React80.useCallback((item) => {
  ...
  const handleRemoveAll = React80.useCallback(() => {
  ...
  return (0, import_jsx_runtime61.jsxs)(GridPanelWrapper, _extends({
    ref
  }, other, {
...
function GridColumnsManagement(props) {
  var _a, _b, _c, _d;
  const apiRef = useGridApiContext();
  const searchInputRef = React81.useRef(null);
  ...
  const rootProps = useGridRootProps();
  const [searchValue, setSearchValue] = React81.useState("");
  ...
  const isResetDisabled = React81.useMemo(() => checkColumnVisibilityModelsSame(columnVisibilityModel, initialColumnVisibilityModel), [columnVisibilityModel, initialColumnVisibilityModel]);
  const sortedColumns = React81.useMemo(() => {
    switch (sort) {
      case "asc":
  ...
  const currentColumns = React81.useMemo(() => {
  ...
  const toggleAllColumns = React81.useCallback((isVisible) => {
  ...
  const handleSearchValueChange = React81.useCallback((event) => {
    setSearchValue(event.target.value);
  }, []);
  const hideableColumns = React81.useMemo(() => currentColumns.filter((col) => col.hideable), [currentColumns]);
  const allHideableColumnsVisible = React81.useMemo(() => hideableColumns.every((column) => columnVisibilityModel[column.field] == null || columnVisibilityModel[column.field] !== false), [columnVisibilityModel, hideableColumns]);
  const allHideableColumnsHidden = React81.useMemo(() => hideableColumns.every((column) => columnVisibilityModel[column.field] === false), [columnVisibilityModel, hideableColumns]);
  const firstSwitchRef = React81.useRef(null);
  React81.useEffect(() => {
  ...
  const handleSearchReset = React81.useCallback(() => {
    setSearchValue("");
    searchInputRef.current.focus();
  }, []);
...
true ? GridColumnsManagement.propTypes = {
  ...
  searchInputProps: import_prop_types44.default.object,
...
function GridToolbarQuickFilter(props) {
  ...
  React87.useEffect(() => debouncedUpdateSearchValue.clear, [debouncedUpdateSearchValue]);
...
var useGridRowAriaAttributes = () => {
  ...
  const headerGroupingMaxDepth = useGridSelector(apiRef, gridColumnGroupsHeaderMaxDepthSelector);
  return React100.useCallback((rowNode, index) => {
...
function GridContextProvider({
  ...
  const apiRef = React101.useRef(privateApiRef.current.getPublicApi());
...
var useGridRefs = (apiRef) => {
  const rootElementRef = React102.useRef(null);
  const mainElementRef = React102.useRef(null);
  const virtualScrollerRef = React102.useRef(null);
  const virtualScrollbarVerticalRef = React102.useRef(null);
  const virtualScrollbarHorizontalRef = React102.useRef(null);
  const columnHeadersContainerRef = React102.useRef(null);
...
var useGridIsRtl = (apiRef) => {
  ...
  const isFirstEffect = React103.useRef(true);
  React103.useEffect(() => {
...
var useGridLoggerFactory = (apiRef, props) => {
  const getLogger = React104.useCallback((name) => {
    if (forceDebug) {
...
function useGridApiInitialization(inputApiRef, props) {
  var _a;
  const publicApiRef = React105.useRef();
  const privateApiRef = React105.useRef();
  ...
  const publishEvent = React105.useCallback((...args) => {
  ...
  const subscribeEvent = React105.useCallback((event, handler, options) => {
  ...
  React105.useImperativeHandle(inputApiRef, () => publicApiRef.current, [publicApiRef]);
  React105.useEffect(() => {
    const api = privateApiRef.current;
    return () => {
...
var useGridLocaleText = (apiRef, props) => {
  const getLocaleText = React106.useCallback((key) => {
...
var useGridPipeProcessing = (apiRef) => {
  const cache2 = React107.useRef({});
  const isRunning = React107.useRef(false);
  const runAppliers = React107.useCallback((groupCache) => {
  ...
  const registerPipeProcessor = React107.useCallback((group, id, processor) => {
  ...
  const registerPipeApplier = React107.useCallback((group, id, applier) => {
    if (!cache2.current[group]) {
      cache2.current[group] = {
        processors: /* @__PURE__ */ new Map(),
        processorsAsArray: [],
  ...
  const requestPipeProcessorsApplication = React107.useCallback((group) => {
    runAppliers(cache2.current[group]);
  }, [runAppliers]);
  const applyPipeProcessors = React107.useCallback((...args) => {
...
var useGridStrategyProcessing = (apiRef) => {
  const availableStrategies = React111.useRef(/* @__PURE__ */ new Map());
  const strategiesCache = React111.useRef({});
  const registerStrategyProcessor = React111.useCallback((strategyName, processorName, processor) => {
    const cleanup = () => {
  ...
  const applyStrategyProcessor = React111.useCallback((processorName, params) => {
  ...
  const getActiveStrategy = React111.useCallback((strategyGroup) => {
  ...
  const setStrategyAvailability = React111.useCallback((strategyGroup, strategyName, isAvailable) => {
...
var useGridStateInitialization = (apiRef) => {
  const controlStateMapRef = React112.useRef({});
  const [, rawForceUpdate] = React112.useState();
  const registerControlState = React112.useCallback((controlStateItem) => {
    controlStateMapRef.current[controlStateItem.stateId] = controlStateItem;
  }, []);
  const setState = React112.useCallback((state, reason) => {
    let newState;
    if (isFunction(state)) {
  ...
  const updateControlState = React112.useCallback((key, state, reason) => {
  ...
  const forceUpdate = React112.useCallback(() => rawForceUpdate(() => apiRef.current.state), [apiRef]);
...
var useGridInitializeState = (initializer, privateApiRef, props) => {
  const isInitialized = React113.useRef(false);
...
var useGridClipboard = (apiRef, props) => {
  ...
  const handleCopy = React114.useCallback((event) => {
...
var useGridColumnMenu = (apiRef) => {
  ...
  const showColumnMenu = React115.useCallback((field) => {
  ...
  const hideColumnMenu = React115.useCallback(() => {
    const columnMenuState = gridColumnMenuSelector(apiRef.current.state);
  ...
  const toggleColumnMenu = React115.useCallback((field) => {
...
function useGridColumns(apiRef, props) {
  ...
  const previousColumnsProp = React116.useRef(props.columns);
  ...
  const setGridColumnsState = React116.useCallback((columnsState) => {
    var _a2, _b2;
  ...
  const getColumn = React116.useCallback((field) => gridColumnLookupSelector(apiRef)[field], [apiRef]);
  const getAllColumns = React116.useCallback(() => gridColumnDefinitionsSelector(apiRef), [apiRef]);
  const getVisibleColumns = React116.useCallback(() => gridVisibleColumnDefinitionsSelector(apiRef), [apiRef]);
  const getColumnIndex = React116.useCallback((field, useVisibleColumns = true) => {
    const columns = useVisibleColumns ? gridVisibleColumnDefinitionsSelector(apiRef) : gridColumnDefinitionsSelector(apiRef);
    return columns.findIndex((col) => col.field === field);
  }, [apiRef]);
  const getColumnPosition = React116.useCallback((field) => {
    const index = getColumnIndex(field);
    return gridColumnPositionsSelector(apiRef)[index];
  }, [apiRef, getColumnIndex]);
  const setColumnVisibilityModel = React116.useCallback((model) => {
    var _a2, _b2;
    const currentModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const updateColumns = React116.useCallback((columns) => {
    const columnsState = createColumnsState({
      apiRef,
  ...
  const setColumnVisibility = React116.useCallback((field, isVisible) => {
    const columnVisibilityModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const getColumnIndexRelativeToVisibleColumns = React116.useCallback((field) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
    return allColumns.findIndex((col) => col === field);
  }, [apiRef]);
  const setColumnIndex = React116.useCallback((field, targetIndexPosition) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
  ...
  const setColumnWidth = React116.useCallback((field, width) => {
  ...
  const preferencePanelPreProcessing = React116.useCallback((initialValue, value) => {
    var _a2;
  ...
  const addColumnMenuItems = React116.useCallback((columnMenuItems) => {
  ...
  const prevInnerWidth = React116.useRef(null);
  ...
  const hydrateColumns = React116.useCallback(() => {
...
var useGridCsvExport = (apiRef, props) => {
  ...
  const getDataAsCsv = React118.useCallback((options = {}) => {
  ...
  const exportDataAsCsv = React118.useCallback((options) => {
...
var useGridPaginationModel = (apiRef, props) => {
  ...
  const setPage = React119.useCallback((page) => {
  ...
  const setPageSize = React119.useCallback((pageSize) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const setPaginationModel = React119.useCallback((paginationModel) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const handleUpdateAutoPageSize = React119.useCallback(() => {
  ...
  const handleRowCountChange = React119.useCallback((newRowCount) => {
    if (newRowCount == null) {
      return;
    }
    const paginationModel = gridPaginationModelSelector(apiRef);
  ...
  React119.useEffect(handleUpdateAutoPageSize, [handleUpdateAutoPageSize]);
};
...
var useGridPrintExport = (apiRef, props) => {
  ...
  const doc = React120.useRef(null);
  const previousGridState = React120.useRef(null);
  const previousColumnVisibility = React120.useRef({});
  const previousRows = React120.useRef([]);
  const previousVirtualizationState = React120.useRef();
  React120.useEffect(() => {
    doc.current = ownerDocument(apiRef.current.rootElementRef.current);
  }, [apiRef, hasRootReference]);
  const updateGridColumnsForPrint = React120.useCallback((fields, allColumns, includeCheckboxes) => new Promise((resolve) => {
  ...
  const updateGridRowsForPrint = React120.useCallback((getRowsToExport) => {
  ...
  const handlePrintWindowLoad = React120.useCallback((printWindow, options) => {
    var _a, _b, _c, _d;
...
`;
  ...
  const handlePrintWindowAfterPrint = React120.useCallback((printWindow) => {
    var _a, _b;
  ...
  const exportDataAsPrint = React120.useCallback(async (options) => {
...
var useGridFilter = (apiRef, props) => {
  ...
  const updateFilteredRows = React121.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const addColumnMenuItem = React121.useCallback((columnMenuItems, colDef) => {
    if (colDef == null || colDef.filterable === false || props.disableColumnFilter) {
      return columnMenuItems;
    }
    return [...columnMenuItems, "columnMenuFilterItem"];
  }, [props.disableColumnFilter]);
  const applyFilters = React121.useCallback(() => {
    updateFilteredRows();
    apiRef.current.forceUpdate();
  }, [apiRef, updateFilteredRows]);
  const upsertFilterItem = React121.useCallback((item) => {
  ...
  const upsertFilterItems = React121.useCallback((items) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const deleteFilterItem = React121.useCallback((itemToDelete) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const showFilterPanel = React121.useCallback((targetColumnField, panelId, labelId) => {
  ...
  const hideFilterPanel = React121.useCallback(() => {
    logger.debug("Hiding filter panel");
    apiRef.current.hidePreferences();
  }, [apiRef, logger]);
  const setFilterLogicOperator = React121.useCallback((logicOperator) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setQuickFilterValues = React121.useCallback((values) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setFilterModel = React121.useCallback((model, reason) => {
  ...
  const getFilterState = React121.useCallback((inputFilterModel) => {
  ...
  const preferencePanelPreProcessing = React121.useCallback((initialValue, value) => {
    var _a2;
  ...
  const flatFilteringMethod = React121.useCallback((params) => {
  ...
  const handleColumnsChange = React121.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React121.useCallback((methodName) => {
    if (methodName === "filtering") {
      apiRef.current.unstable_applyFilters();
    }
  }, [apiRef]);
  const updateVisibleRowsLookupState = React121.useCallback(() => {
    apiRef.current.setState((state) => {
      return _extends({}, state, {
...
var useGridFocus = (apiRef, props) => {
  ...
  const lastClickedCell = React122.useRef(null);
  const hasRootReference = apiRef.current.rootElementRef.current !== null;
  const publishCellFocusOut = React122.useCallback((cell, event) => {
    if (cell) {
  ...
  const setCellFocus = React122.useCallback((id, field) => {
    const focusedCell = gridFocusCellSelector(apiRef);
  ...
  const setColumnHeaderFocus = React122.useCallback((field, event = {}) => {
  ...
  const setColumnHeaderFilterFocus = React122.useCallback((field, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    publishCellFocusOut(cell, event);
    apiRef.current.setState((state) => {
  ...
  const setColumnGroupHeaderFocus = React122.useCallback((field, depth, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    if (cell) {
      apiRef.current.publishEvent("cellFocusOut", apiRef.current.getCellParams(cell.id, cell.field), event);
    }
  ...
  const getColumnGroupHeaderFocus = React122.useCallback(() => gridFocusColumnGroupHeaderSelector(apiRef), [apiRef]);
  const moveFocusToRelativeCell = React122.useCallback((id, field, direction) => {
  ...
  const handleCellDoubleClick = React122.useCallback(({
    id,
    field
  }) => {
  ...
  const handleColumnHeaderFocus = React122.useCallback(({
    field
  }, event) => {
  ...
  const handleColumnGroupHeaderFocus = React122.useCallback(({
    fields,
    depth
  }, event) => {
    if (event.target !== event.currentTarget) {
  ...
  const handleBlur = React122.useCallback((_, event) => {
    var _a, _b;
  ...
  const handleCellMouseDown = React122.useCallback((params) => {
    lastClickedCell.current = params;
  }, []);
  const handleDocumentClick = React122.useCallback((event) => {
  ...
  const handleCellModeChange = React122.useCallback((params) => {
  ...
  const handleRowSet = React122.useCallback(() => {
    var _a;
    const cell = gridFocusCellSelector(apiRef);
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const currentPageRows = React123.useMemo(() => enrichPageRowsWithPinnedRows(apiRef, initialCurrentPageRows), [apiRef, initialCurrentPageRows]);
  const headerFilteringEnabled = props.signature !== "DataGrid" && props.headerFilters;
  const goToCell = React123.useCallback((colIndex, rowId, closestColumnToUse = "left", rowSpanScanDirection = "up") => {
  ...
  const goToHeader = React123.useCallback((colIndex, event) => {
  ...
  const goToHeaderFilter = React123.useCallback((colIndex, event) => {
  ...
  const goToGroupHeader = React123.useCallback((colIndex, depth, event) => {
    logger.debug(`Navigating to header col ${colIndex}`);
    apiRef.current.scrollToIndexes({
      colIndex
    });
  ...
  const getRowIdFromIndex = React123.useCallback((rowIndex) => {
    var _a;
    return (_a = currentPageRows[rowIndex]) == null ? void 0 : _a.id;
  }, [currentPageRows]);
  const handleColumnHeaderKeyDown = React123.useCallback((params, event) => {
  ...
  const handleHeaderFilterKeyDown = React123.useCallback((params, event) => {
  ...
  const handleColumnGroupHeaderKeyDown = React123.useCallback((params, event) => {
    const focusedColumnGroup = gridFocusColumnGroupHeaderSelector(apiRef);
  ...
  const checkIfCanStartEditing = React123.useCallback((initialValue, {
    event
  }) => {
    if (event.key === " ") {
      return false;
...
var useGridRowCount = (apiRef, props) => {
  ...
  const setRowCount = React124.useCallback((newRowCount) => {
  ...
  useGridRegisterPipeProcessor(apiRef, "exportState", stateExportPreProcessing);
  useGridRegisterPipeProcessor(apiRef, "restoreState", stateRestorePreProcessing);
  const handlePaginationModelChange = React124.useCallback((model) => {
...
var useGridPaginationMeta = (apiRef, props) => {
  ...
  const setPaginationMeta = React125.useCallback((newPaginationMeta) => {
...
var useGridRowEditing = (apiRef, props) => {
  ...
  const focusTimeout = React128.useRef();
  ...
  const hasFieldsWithErrors = React128.useCallback((rowId) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
...
var useGridRows = (apiRef, props) => {
  ...
  const lastRowCount = React130.useRef(props.rowCount);
  const timeout = useTimeout();
  ...
  const updateServerRows = React130.useCallback((updates, groupKeys) => {
    const nonPinnedRowsUpdates = computeRowsUpdates(apiRef, updates, props.getRowId);
    const cache2 = updateCacheWithNewRows({
      updates: nonPinnedRowsUpdates,
      getRowId: props.getRowId,
  ...
  const setLoading = React130.useCallback((loading) => {
  ...
  const getRowNode = React130.useCallback((id) => gridRowTreeSelector(apiRef)[id] ?? null, [apiRef]);
...
function useGridParamsApi(apiRef, props) {
  const getColumnHeaderParams = React131.useCallback((field) => ({
    field,
    colDef: apiRef.current.getColumn(field)
  }), [apiRef]);
  const getRowParams = React131.useCallback((id) => {
    const row = apiRef.current.getRow(id);
    if (!row) {
  ...
  const getCellParams = React131.useCallback((id, field) => {
  ...
  const getCellValue2 = React131.useCallback((id, field) => {
    const colDef = apiRef.current.getColumn(field);
    const row = apiRef.current.getRow(id);
    if (!row) {
      throw new MissingRowIdError(`No row with id #${id} found`);
  ...
  const getRowValue = React131.useCallback((row, colDef) => {
  ...
  const getRowFormattedValue = React131.useCallback((row, colDef) => {
  ...
  const getColumnHeaderElement = React131.useCallback((field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridColumnHeaderElement(apiRef.current.rootElementRef.current, field);
  }, [apiRef]);
  const getRowElement = React131.useCallback((id) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridRowElement(apiRef.current.rootElementRef.current, id);
  }, [apiRef]);
  const getCellElement = React131.useCallback((id, field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
...
var useGridRowSelection = (apiRef, props) => {
  ...
  const runIfRowSelectionIsEnabled = React132.useCallback((callback) => (...args) => {
  ...
  const propRowSelectionModel = React132.useMemo(() => {
    return getSelectionModelPropValue(props.rowSelectionModel, gridRowSelectionStateSelector(apiRef.current.state));
  }, [apiRef, props.rowSelectionModel]);
  const lastRowToggled = React132.useRef(null);
  apiRef.current.registerControlState({
  ...
  const expandMouseRowRangeSelection = React132.useCallback((id) => {
    let endId = id;
  ...
  const setRowSelectionModel = React132.useCallback((model) => {
  ...
  const isRowSelected = React132.useCallback((id) => gridRowSelectionStateSelector(apiRef.current.state).includes(id), [apiRef]);
  const isRowSelectable = React132.useCallback((id) => {
  ...
  const getSelectedRows = React132.useCallback(() => selectedGridRowsSelector(apiRef), [apiRef]);
  const selectRow = React132.useCallback((id, isSelected = true, resetSelection = false) => {
  ...
  const selectRows = React132.useCallback((ids, isSelected = true, resetSelection = false) => {
  ...
  const selectRowRange = React132.useCallback(({
    startId,
    endId
  ...
  const removeOutdatedSelection = React132.useCallback((sortModelUpdated = false) => {
    var _a2;
  ...
  const handleSingleRowSelection = React132.useCallback((id, event) => {
  ...
  const handleRowClick = React132.useCallback((params, event) => {
    var _a2;
  ...
  const preventSelectionOnShift = React132.useCallback((params, event) => {
    var _a2;
    if (canHaveMultipleSelection && event.shiftKey) {
      (_a2 = window.getSelection()) == null ? void 0 : _a2.removeAllRanges();
    }
  }, [canHaveMultipleSelection]);
  const handleRowSelectionCheckboxChange = React132.useCallback((params, event) => {
  ...
  const handleHeaderSelectionCheckboxChange = React132.useCallback((params) => {
  ...
  const handleCellKeyDown = React132.useCallback((params, event) => {
...
var useGridRowSelectionPreProcessors = (apiRef, props) => {
  ...
  const updateSelectionColumn = React133.useCallback((columnsState) => {
...
var useGridSorting = (apiRef, props) => {
  ...
  const upsertSortModel = React134.useCallback((field, sortItem) => {
  ...
  const createSortItem = React134.useCallback((col, directionOverride) => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const applySorting = React134.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const setSortModel = React134.useCallback((model) => {
  ...
  const sortColumn = React134.useCallback((field, direction, allowMultipleSorting) => {
    const column = apiRef.current.getColumn(field);
  ...
  const getSortModel = React134.useCallback(() => gridSortModelSelector(apiRef), [apiRef]);
  const getSortedRows = React134.useCallback(() => {
    const sortedRows = gridSortedRowEntriesSelector(apiRef);
    return sortedRows.map((row) => row.model);
  }, [apiRef]);
  const getSortedRowIds = React134.useCallback(() => gridSortedRowIdsSelector(apiRef), [apiRef]);
  const getRowIdFromRowIndex = React134.useCallback((index) => apiRef.current.getSortedRowIds()[index], [apiRef]);
  const sortApi = {
    getSortModel,
    getSortedRows,
    getSortedRowIds,
  ...
  const flatSortingMethod = React134.useCallback((params) => {
    const rowTree = gridRowTreeSelector(apiRef);
  ...
  const handleColumnHeaderClick = React134.useCallback(({
    field,
    colDef
  }, event) => {
  ...
  const handleColumnHeaderKeyDown = React134.useCallback(({
    field,
    colDef
  }, event) => {
    if (!colDef.sortable || props.disableColumnSorting) {
...
var useGridScroll = (apiRef, props) => {
  ...
  const scrollToIndexes = React135.useCallback((params) => {
    var _a;
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const scroll = React135.useCallback((params) => {
  ...
  const getScrollPosition = React135.useCallback(() => {
...
function useGridDimensions(apiRef, props) {
  ...
  const errorShown = React136.useRef(false);
  const rootDimensionsRef = React136.useRef(EMPTY_SIZE);
  const dimensionsState = useGridSelector(apiRef, gridDimensionsSelector);
  const rowsMeta = useGridSelector(apiRef, gridRowsMetaSelector);
  const pinnedColumns = useGridSelector(apiRef, gridVisiblePinnedColumnDefinitionsSelector);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const validRowHeight = React136.useMemo(() => getValidRowHeight(props.rowHeight, DATA_GRID_PROPS_DEFAULT_VALUES.rowHeight, rowHeightWarning), [props.rowHeight]);
  ...
  const [savedSize, setSavedSize] = React136.useState();
  const debouncedSetSavedSize = React136.useMemo(() => throttle(setSavedSize, props.resizeThrottleMs), [props.resizeThrottleMs]);
  React136.useEffect(() => debouncedSetSavedSize.clear, [debouncedSetSavedSize]);
  const previousSize = React136.useRef();
  ...
  const resize = React136.useCallback(() => {
  ...
  const getViewportPageSize = React136.useCallback(() => {
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const updateDimensions = React136.useCallback(() => {
    var _a, _b;
  ...
  const isFirstSizing = React136.useRef(true);
  const handleResize = React136.useCallback((size) => {
...
var useGridRowsMeta = (apiRef, props) => {
  ...
  const lastMeasuredRowIndex = React137.useRef(-1);
  const hasRowWithAutoHeight = React137.useRef(false);
  const isHeightMetaValid = React137.useRef(false);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const filterModel = useGridSelector(apiRef, gridFilterModelSelector);
  ...
  const processHeightEntry = React137.useCallback((row) => {
  ...
  const hydrateRowsMeta = React137.useCallback(() => {
...
var useGridStatePersistence = (apiRef) => {
  const exportState = React138.useCallback((params = {}) => {
    const stateToExport = apiRef.current.unstable_applyPipeProcessors("exportState", {}, params);
    return stateToExport;
  }, [apiRef]);
  const restoreState = React138.useCallback((stateToRestore) => {
...
var useGridColumnSpanning = (apiRef) => {
  ...
  const calculateColSpan = React139.useCallback(({
    rowId,
    minFirstColumn,
    maxLastColumn,
    columns
...
var useGridColumnGrouping = (apiRef, props) => {
  const getColumnGroupPath = React140.useCallback((field) => {
    const unwrappedGroupingModel = gridColumnGroupsUnwrappedModelSelector(apiRef);
    return unwrappedGroupingModel[field] ?? [];
  }, [apiRef]);
  const getAllGroupDetails = React140.useCallback(() => {
  ...
  const handleColumnIndexChange = React140.useCallback(() => {
    const unwrappedGroupingModel = unwrapGroupingColumnModel(props.columnGroupingModel ?? []);
    apiRef.current.setState((state) => {
      var _a;
  ...
  const updateColumnGroupingState = React140.useCallback((columnGroupingModel) => {
    var _a, _b;
...
var useGridColumnResize = (apiRef, props) => {
  ...
  const initialOffsetToSeparator = React141.useRef();
  const resizeDirection = React141.useRef();
  const stopResizeEventTimeout = useTimeout();
  const touchId = React141.useRef();
  ...
  const stopListening = React141.useCallback(() => {
    const doc = ownerDocument(apiRef.current.rootElementRef.current);
  ...
  const handleResizeStart = React141.useCallback(({
    field
  }) => {
    apiRef.current.setState((state) => _extends({}, state, {
  ...
  const handleResizeStop = React141.useCallback(() => {
    apiRef.current.setState((state) => _extends({}, state, {
      columnResize: _extends({}, state.columnResize, {
        resizingColumnField: ""
      })
  ...
  const isAutosizingRef = React141.useRef(false);
  const autosizeColumns = React141.useCallback(async (userOptions) => {
    var _a;
  ...
  React141.useEffect(() => stopListening, [stopListening]);
  useOnMount(() => {
...
var useGridRowSpanning = (apiRef, props) => {
  ...
  const lastRange = React142.useRef(EMPTY_RANGE);
  const updateRowSpanningState = React142.useCallback(
  ...
  const prevRenderContext = React142.useRef(renderContext);
  const isFirstRender = React142.useRef(true);
  const shouldResetState = React142.useRef(false);
  const previousTree = React142.useRef(tree);
  React142.useEffect(() => {
...
function useGridListView(apiRef, props) {
  ...
  const prevInnerWidth = React143.useRef(null);
  const handleGridSizeChange = (viewportInnerSize) => {
    if (prevInnerWidth.current !== viewportInnerSize.width) {
      prevInnerWidth.current = viewportInnerSize.width;
...
function GridColumnGroupHeader(props) {
  ...
  const rootProps = useGridRootProps();
  const headerCellRef = React144.useRef(null);
  const apiRef = useGridApiContext();
  ...
  const renderParams = React144.useMemo(() => ({
    groupId,
    headerName,
    description,
    depth,
  ...
  const publish = React144.useCallback(
    (eventName) => (event) => {
      if (isEventTargetInPortal(event)) {
        return;
      }
  ...
  const mouseEventsHandlers = React144.useMemo(() => ({
...
var useGridColumnHeaders = (props) => {
  ...
  const [dragCol, setDragCol] = React145.useState("");
  const [resizeCol, setResizeCol] = React145.useState("");
  const apiRef = useGridPrivateApiContext();
  const isRtl = useRtl();
  const rootProps = useGridRootProps();
  const dimensions = useGridSelector(apiRef, gridDimensionsSelector);
  ...
  const handleColumnResizeStart = React145.useCallback((params) => setResizeCol(params.field), []);
  const handleColumnResizeStop = React145.useCallback(() => setResizeCol(""), []);
  const handleColumnReorderStart = React145.useCallback((params) => setDragCol(params.field), []);
  const handleColumnReorderStop = React145.useCallback(() => setDragCol(""), []);
  const leftRenderContext = React145.useMemo(() => {
    return pinnedColumns.left.length ? {
      firstColumnIndex: 0,
      lastColumnIndex: pinnedColumns.left.length
    } : null;
  }, [pinnedColumns.left.length]);
  const rightRenderContext = React145.useMemo(() => {
  ...
  const getFillers = (params, children, leftOverflow, borderBottom = false) => {
    ...
    return (0, import_jsx_runtime87.jsxs)(React145.Fragment, {
...
var GridBaseColumnHeaders = React146.forwardRef(function GridColumnHeaders(props, ref) {
  const {
    className
...
var GridColumnHeaders2 = React147.forwardRef(function GridColumnHeaders3(props, ref) {
  const {
    visibleColumns,
    sortColumnLookup,
    filterColumnLookup,
...
var GridNoResultsOverlay = React148.forwardRef(function GridNoResultsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var GridColumnUnsortedIcon = React149.memo(function GridColumnHeaderSortIcon2(props) {
  const {
    sortingOrder
...
function useProps(allProps) {
  return React151.useMemo(() => groupForwardedProps(allProps), [allProps]);
}
...
var useDataGridProps = (inProps) => {
  ...
  const localeText = React152.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const slots = React152.useMemo(() => computeSlots({
    defaultSlots,
    slots: themedProps.slots
  }), [themedProps.slots]);
  const injectDefaultProps = React152.useMemo(() => {
    return Object.keys(DATA_GRID_PROPS_DEFAULT_VALUES).reduce((acc, key) => {
      acc[key] = themedProps[key] ?? DATA_GRID_PROPS_DEFAULT_VALUES[key];
      return acc;
    }, {});
  }, [themedProps]);
  return React152.useMemo(() => _extends({}, themedProps, injectDefaultProps, {
    localeText,
    slots
...
DataGridRaw.propTypes = {
  ...
  autosizeOptions: import_prop_types60.default.shape({
    ...
    disableColumnVirtualization: import_prop_types60.default.bool,
   ...
   * @default false
   */
  virtualizeColumnsWithAutoRowHeight: import_prop_types60.default.bool
};
export {
