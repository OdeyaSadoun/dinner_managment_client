    ...
    var fillReserved = function() {
      ...
      return function fillReserved2(matrix, ec_level, mask) {
        ...
        for (var i2 = 0; i2 < 8; i2++) {
          ...
          if (i2 < 6) matrix[i2][8] = F(i2);
        }
        for (var i2 = 8; i2 < 15; i2++) {
          matrix[N - 15 + i2][8] = F(i2);
          if (i2 > 8) matrix[8][14 - i2] = F(i2);
        }
        matrix[7][8] = F(6);
        matrix[8][8] = F(7);
        matrix[8][7] = F(8);
...
var require_mutable_buffer = __commonJS({
  "node_modules/mutable-buffer/dist/mutable-buffer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MutableBuffer = void 0;
    var DEFAULT_INITIAL_SIZE = 1024;
    var DEFAULT_BLOCK_SIZE = 1024;
    var MutableBuffer = class {
...
var require_dist = __commonJS({
  "node_modules/mutable-buffer/dist/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
    tslib_1.__exportStar(require_mutable_buffer(), exports);
    var mutable_buffer_1 = require_mutable_buffer();
...
var require_image = __commonJS({
  "node_modules/escpos/image.js"(exports, module) {
    "use strict";
    var getPixels = require_dom_pixels();
    function Image2(pixels) {
      if (!(this instanceof Image2))
        return new Image2(pixels);
      this.pixels = pixels;
      this.data = [];
      function rgb(pixel) {
        return {
    ...
    Image2.load = function(url, type, callback) {
      ...
      getPixels(url, type, function(err, pixels) {
        ...
        callback(new Image2(pixels));
      });
    };
    Image2.prototype.__defineGetter__("size", function() {
      return {
    ...
    Image2.prototype.toBitmap = function(density) {
      density = density || 24;
      var ld, result = [];
      var x, y, b, l, i;
      var c = density / 8;
    ...
    Image2.prototype.toRaster = function() {
      var result = [];
...
var require_utils = __commonJS({
  "node_modules/escpos/utils.js"(exports) {
...
var require_commands = __commonJS({
  "node_modules/escpos/commands.js"(exports, module) {
...
var require_promisify = __commonJS({
  "node_modules/escpos/promisify.js"(exports, module) {
...
var require_statuses = __commonJS({
  "node_modules/escpos/statuses.js"(exports, module) {
    var _ = require_commands();
    var NotImplementedException = class extends Error {
    };
    var DeviceStatus = class {
      constructor(byte) {
        __publicField(this, "byte", "");
        __publicField(this, "bits", []);
        __publicField(this, "bitsAsc", []);
        this.byte = byte;
        for (let j = 7; j >= 0; j--) {
    ...
    var PrinterStatus = class extends DeviceStatus {
      static commands() {
    ...
    var OfflineCauseStatus = class extends DeviceStatus {
      static commands() {
    ...
    var ErrorCauseStatus = class extends DeviceStatus {
      static commands() {
    ...
    var RollPaperSensorStatus = class extends DeviceStatus {
      static commands() {
...
var require_escpos = __commonJS({
  "node_modules/escpos/index.js"(exports, module) {
    var util = require_util();
    var qr = require_qr();
    var iconv = require_lib();
    var getPixels = require_dom_pixels();
    var { MutableBuffer } = require_dist();
    var EventEmitter = require_events();
    var Image2 = require_image();
    var utils = require_utils();
    var _ = require_commands();
    var Promiseify = require_promisify();
    var statuses = require_statuses();
    var { PrinterStatus, OfflineCauseStatus, ErrorCauseStatus, RollPaperSensorStatus } = statuses;
    ...
    Printer.prototype.getStatuses = function(callback) {
      ...
      this.adapter.read((data) => {
        ...
        for (let i = 0; i < buffer.length; i++) {
          ...
          switch (i) {
            case 0:
              statuses2.push(new PrinterStatus(byte));
              break;
            case 1:
              statuses2.push(new RollPaperSensorStatus(byte));
              break;
            case 2:
              statuses2.push(new OfflineCauseStatus(byte));
              break;
            case 3:
              statuses2.push(new ErrorCauseStatus(byte));
              break;
          }
        }
        buffer = [];
    ...
    Printer.Image = require_image();
    Printer.command = require_commands();
    Printer.Printer2 = require_promisify();
    module.exports = Printer;
  }
});
export default require_escpos();
